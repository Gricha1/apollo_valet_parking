...
parser.add_argument('-dynamic_dence', '--dynamic_dence', type=float, default=0)
parser.add_argument('-dynamic', '--dynamic', type = bool, default=False)
parser.add_argument('-map', '--map', type=str)
parser.add_argument('-parking_number', '--number_of_place', type=int)
args = parser.parse_args()
p = float(args.dynamic_dence)
dynamic = False
...
if args.map == "test":
    ...
    assert 1 == 0, "please specify -map parameter: -map test, -map parking_lot"
